      ...
      <div className='flexBetween py-3'>
        ...
        <div className='flexBetween sm:gap-x-2 bold-16'>
          ...
          <div className='flexBetween sm:gap-x-2'>
            ...
            {localStorage.getItem('auth-token') ? <NavLink onClick={() => { localStorage.removeItem('auth-token'); window.location.replace('/') }} to={'logout'} className={"btn-secondary flexCenter gap-x-2 medium-16 rounded-full"}><img src={logout} height={19} width={19} alt='logoutIcon' />LogOut</NavLink> :
